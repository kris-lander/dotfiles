...
sudo scutil --set ComputerName "Kris MPB"
sudo scutil --set HostName "Kris MPB"
sudo scutil --set LocalHostName "Kris-MPB"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "Kris-MPB"
